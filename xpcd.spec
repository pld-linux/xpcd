...
Summary(pl):	NarzÍdzia do obs≥ugi formatu PhotoCD
Name:		xpcd
Version:	2.08
Release:	4
License:	GPL
...
%description -l pl
Zestaw narzÍdzi do obrÛbki formatu PhotoCD. G≥Ûwna aplikacja (xpcd)
jest programem pod X do dekodowania i ogl±dania obrazkÛw PhotoCD.
pcdtoppm jest konwerterem na ppm i jpg dzia≥aj±cym z linii poleceÒ.
...
Przegl±darka obrazkÛw PhotoCD korzystaj±ca z svgalib.

%endif

%package gimp
Summary:	GIMP plugin, makes xpcd and gimp work hand in hand.
Summary(pl):	Wtyczka do GIMP-a dodaj±ca obs≥ugÍ xpcd.
Group:		X11/Applications/Graphics
Group(de):	X11/Applikationen/Grafik
Group(pl):	X11/Aplikacje/Grafika
Group(pt):	X11/AplicaÁıes/Gr·ficos
...
Wtyczka do GIMP-a >= 0.99, pozwalaj±ca wczytywaÊ obrazki PhotoCD
...
Summary(pl):	Pliki nag≥Ûwkowe do libpcd
...
Pliki nag≥Ûwkowe do biblioteki libpcd.
